...
```
cd existing_repo
git remote add origin https://gitlab.com/Nico_64/ncurses-chess.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/Nico_64/ncurses-chess/-/settings/integrations)
...
## Installation
Whenever I setup cmake, you can make. For now, do `g++ -YOURFLAGSHERE -lncursesw *.cpp`
